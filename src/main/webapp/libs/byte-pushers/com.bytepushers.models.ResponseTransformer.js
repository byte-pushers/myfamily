 ...
 */
BytePushers.models.ResponseTransformer.transformJSONResponse = function (jsonResponse, payloadTransformer, user, transFormPayload) {
    'use strict';
    ...
    if (responseStatus.getRequestStatus().toLowerCase() === "Successful".toLowerCase()) {
        ...
        responsePayload = (transFormPayload)? payloadTransformer.transformJSONPayload(jsonResponse.payload, user) : null;
    }
